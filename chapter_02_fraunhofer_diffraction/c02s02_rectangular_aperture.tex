...
elementary calculus. Denote the actual integral by $V$. That is:
...
It is good programming practice to collect commonly used constants and
functions in a file (or module, or package, or library, depending on which
programming language you are using and depending on how many constants and
functions you need). Several of our programs will be using the same wavelength
of light and the same setup parameters for the plots and images. Let's collect
these in a file and call it \texttt{common.py}.

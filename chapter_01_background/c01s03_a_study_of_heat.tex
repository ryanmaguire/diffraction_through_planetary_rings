...
but such a problem isn't even \textit{well-posed}. The solutions to these
equations are highly sensitive to the \textit{initial conditions}, which are
...
and his methods led to the discovery of \textit{Fourier analysis},
\textit{Fourier series}, and \textit{Fourier transforms}.
...
\textit{linear partial differential equation}. He the proposed summing

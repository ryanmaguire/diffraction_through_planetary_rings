...
\textit{wave equation}, not the heat equation. We mimic Fourier's
method, now known as the method of
\hyperref[eq:separation_of_variables]{separation of variables},
...
This is the \textbf{Helmholtz Equation}, which is also known as the
\textbf{Time-Independent Wave Equation}. There are various methods of
tackling this problem, including using separation of variables
\textit{again}. Depending on the coordinate system we use
...
\textit{Bessel functions} arise naturally from this method.

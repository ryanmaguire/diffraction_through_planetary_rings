...
In the 1600's the Italian astronomy Galileo Galilei
proposed an experiment in which two observers standing
atop mountains that are a little over two kilometers apart would
...
light travels at a finite speed from this experiments,
...
speed of light is 299,792,458 meters per second. The fastest
neurons in the human body send electochemical signals at
120 meters per second. In the time it takes light to travel
the 2 kilometers between the mountains the observers stood
on, these signals have only traveled 1 millimeter.
...
then to explain discepencies in the period of Io around Jupiter, one

...
The first known mention of this comes from the writings of the Greek
philosopher Empedocles (\textit{c}. 492 -- 430 B.C.E),
pre-dating Euclidean geometry by at least 100 years
...
outwards at a finite speed. Euclid himself adopted this belief in his books
\textit{Optics} [\cite[p.~1]{BurtonTheOpticsOfEuclid}] and used this as the
very first postulate in his physical model for light,
\footnote{
...
(384 -- 322 B.C.E.) believed there was a major flaw in it. He argues that if
light originates from the eye, and if light travels at a finite speed,
then we would be unable to see things that are very far away the moment
we open our eyes
[\cite[p.~255]{%
...
For nearly two thousand years the Aristotelian belief was held by most
scientists and philosophers, and there was no interest in trying to measure
the speed of light. In 1638 the Italian astronomer Galileo Galilei
(1564 -- 1642 C.E.) proposed an experiment in which two observers standing
atop mountains that are roughly two kilometers apart would
...
The fastest neurons in the human body send electrochemical signals at
120 meters per second. In the time it takes light to travel
the two kilometers between the mountains the observers stood
on, these signals have only traveled one millimeter.
Galileo's conclusion that the speed of light must be orders of magnitude
greater than that of sound is correct: the ratio is nearly $10^{6}$.
\footnote{
    The speed of sound through air at 295 Kelvin (room temperature) is
...
moons. In Isaac Newton's (1642 -- 1726 C.E.) 1704 text \textit{Optiks}
he writes:
...
Newton is eluding to an argument made by Ole R{\o}mer (1644 -- 1710 C.E.).
